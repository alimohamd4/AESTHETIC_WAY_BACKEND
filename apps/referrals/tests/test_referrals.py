...
from apps.accounts.models import UserRole, ClinicUser, PatientProfile
from apps.referrals.models import ReferralPointsLedger, ReferralDiscountCode, DiscountCodeStatus
...
class ReferralTests(APITestCase):
    ...
    def test_clinic_verify_code(self):
        ...
        self.assertEqual(response.data["status"], DiscountCodeStatus.ACTIVE)
    ...
    def test_clinic_redeem_code(self):
        ...
        self.assertEqual(code.status, DiscountCodeStatus.REDEEMED)
